...
namespace AppDebugger {	
	public class SceneScrollRect : DebugScrollRect
	{
	    
	    private List<ScenePieceInfo> datas;
	
	    private ScenePieceInfo selectedLogNode;
	    ...
	    public void Show(List<ScenePieceInfo> data)
	    {
	        datas = data;
	        InnerShow();
	    }
	    ...
	    {
	        SceneCell cell = tableView.DequeueReusable(sectionHeaderIdentifier) as SceneCell;
